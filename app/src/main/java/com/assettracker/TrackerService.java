...
public class TrackerService extends Service implements LocationListener {
    ...
    private void loadPreviousStatuses() {
        ...
        String path = "Vehicles/" + vehicle+"/location";

        Log.e(TAG, "loadPreviousStatuses: path value:"+path );
    ...
    private GoogleApiClient.ConnectionCallbacks mLocationRequestCallback = new GoogleApiClient
        ...
        public void onConnected(Bundle bundle) {
            ...
            mWakelock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "myapp:TrackingWakelock");
            mWakelock.acquire();
        }
    ...
    private void logStatusToStorage(Map<String, Object> transportStatus) {
        try {
            ...
            logFile.close();
            Log.e("TrackerService","path:"+path);
        } catch (Exception e) {
    ...
    private void buildNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            int importance = NotificationManager.IMPORTANCE_DEFAULT;
             channel = new NotificationChannel("my_service", "location chhanel",importance);
